...
public class ChannelController {
    ...
    @GetMapping
    public ResponseEntity<Response<List<String>>> showAllChannel() {
        List<String> channelList = channelService.showAllChannel();
        return ResponseEntity.ok().body(Response.success(channelList));
    }

    @PostMapping
    public ResponseEntity<Response<Long>> createChannel(@RequestBody ChannelCreateRequest channelCreateRequest) {
    ...
    @PatchMapping("/update")
    public ResponseEntity<Response<Long>> updateChannel(@RequestBody ChannelUpdateRequest channelUpdateRequest) {
